create or replace function public.current_user_has_complete_resume()
returns boolean
language sql
stable
security definer
...
revoke all on function public.current_user_has_complete_resume() from public, anon, authenticated;
grant execute on function public.current_user_has_complete_resume() to authenticated;
...
with check (
  ...
  and public.current_user_has_complete_resume()
  and exists (
    select 1
